...
public class C05_Arrays {public static void main(String[] args) {
            /*
    Interwiew Sorusu
...
*/
    ...
    private static void testsonucu(char[][] answers, char[] keys) {
        for (int i = 0; i < answers.length; i++) {//her bir ogrenciyi dolastik i= ogrenci
            int sayac = 0;//her bir ogrencini dogru cevap sayisi
